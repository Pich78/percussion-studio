          ...
          <div class="flex-1 overflow-y-auto p-3 pb-8">
            ...
            <div class="mb-4">
              ...
              <div class="bg-gray-800/50 rounded-2xl border border-gray-700/50">
                ...
                <!-- P1b: Player + Knob -->
                <button data-action="select-view-mode" data-view-id="p1b" class="w-full px-4 py-3 flex items-center gap-3 hover:bg-gray-700/50 active:bg-gray-700 transition-colors rounded-b-2xl">
