/**
 * js/views/mobileToolbarStickyView.js
 * 
 * View definition for the mobile "Proposal 3C - Sticky Footer Strip" view.
 */

import { ToolbarStickyLayout } from '../ui/mobile/toolbar-sticky/layout.js';

export const mobileToolbarStickyView = {
    id: 'mobile-toolbar-sticky',
    name: 'Sticky Footer Strip',
    
    /** Returns the Toolbar Sticky layout HTML */
    layout: ToolbarStickyLayout,
