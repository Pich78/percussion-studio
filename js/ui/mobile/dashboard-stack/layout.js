            ...
            <div class="mb-4">
              ...
              <div class="bg-gray-800/50 rounded-2xl border border-gray-700/50">
                ...
                <button data-action="select-view-mode" data-view-id="p2" class="w-full px-4 py-3 flex items-center gap-3 hover:bg-gray-700/50 active:bg-gray-700 transition-colors border-b border-gray-700/30">
                  ...
                  ${isDashboard ? activeTag : '<span class="text-[10px] text-gray-500 ml-auto">Card carousel</span>'}
                </button>
                <button data-action="select-view-mode" data-view-id="p2a" class="w-full px-4 py-3 flex items-center gap-3 hover:bg-gray-700/50 active:bg-gray-700 transition-colors rounded-b-2xl">
                  <div class="w-7 h-7 rounded-lg bg-teal-500/15 flex items-center justify-center flex-shrink-0">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4 text-teal-400 pointer-events-none">
                      <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 12h16.5m-16.5 3.75h16.5M3.75 19.5h16.5M5.625 4.5h12.75a1.875 1.875 0 010 3.75H5.625a1.875 1.875 0 010-3.75z" />
                    </svg>
                  </div>
                  <span class="text-gray-100 text-sm font-medium">Dashboard — Stack</span>
                  ${isDashboardStack ? activeTag : '<span class="text-[10px] text-gray-500 ml-auto">Vertical stack layout</span>'}
                </button>
              </div>
            </div>
          </div>
