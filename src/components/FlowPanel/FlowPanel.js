...
export class FlowPanel {
    constructor(container, callbacks) {
        ...
        loadCSS('/percussion-studio/src/components/FlowPanel/FlowPanel.css');
        loadCSS('/percussion-studio/src/components/FlowPanel/PatternItemView/PatternItemView.css');
