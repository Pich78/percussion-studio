...
class AudioEngine {
    ...
    /**
     * Attempts to unlock audio on iOS (bypass silent switch).
     * Plays a brief silent sound via HTML5 Audio to trigger "Playback" session.
     */
    unlockAudio() {
        ...
        // 1. Play silent HTML5 audio to force iOS out of "Ambient" mode
        // Store it on the instance to prevent Garbage Collection
        this.silentAudio = new Audio("data:audio/mp3;base64,");
        ...
        if (playPromise !== undefined) {
            playPromise.then(() => {
                console.log("🔊 Audio unlocked (Silent Switch bypass active)");
        ...
        // 2. Also play a silent buffer on the Web Audio API Context to warm it up
        try {
